    ...
    <section class="prod">
        <div class="table-responsive col-lg-12" >
          <table class="table table-hover table-bordeless" style="background-color: #f2f2f2;">
            <h1 class="produtos">Tabela de Usuários <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#CadastroU" style="background-color: #00ff7f;"><i class="bi-plus-lg" style="color: var(--terciary);"></i></button></td></h1>
            ...
            <tbody>
              ...
              <?php
                require "../Controllers/TabelaUsuario.controller.php";
                listar();
              ?>
...
<!-- Modal -->
<div class="modal fade" id="CadastroU" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="../Controllers/CriarUsuario.controller.php" method="POST" class="fornecedor">
          <h1 class="cadP">Cadastro do Usuário</h1>
          <div class="mb-3 row g-3">
              <label for="formGroupExampleInput" class="form-label">Nome</label>
              <input type="text" class="form-control" name="nome" id="formGroupExampleInput" placeholder="Nome do Usuário">
          </div>
          <div class="mb-3 row g-3">
              <label for="formGroupExampleInput2" class="form-label">Senha</label>
              <input type="text" class="form-control" name="senha" id="formGroupExampleInput2" placeholder="Senha do Usuário">
          </div>
          <div class="mb-3 row g-3">
              <label for="formGroupExampleInput2" class="form-label">Nivel Acesso</label>
              <input type="text" class="form-control" name="nivelAcess" id="formGroupExampleInput2" placeholder="Nivel de Acesso">
          </div>
    ...
    <div class="modal fade" id="AlterU" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <!-- <h5 class="modal-title" id="staticBackdropLabel">Modal title</h5> -->
          ...
          <div class="modal-body">
            <form action="" method="POST" id="formAlterar" class="fornecedor">
                <h1 class="cadP">Alterar Usuário</h1>
                <div class="mb-3 row g-3">
                    <label for="formGroupExampleInput" class="form-label">Nome</label>
                    <input type="text" class="form-control" name="nome" id="formGroupExampleInput" placeholder="Nome do Usuário">
                </div>
                ...
                <div class="mb-3 row g-3">
                    <label for="formGroupExampleInput2" class="form-label">Nivel Acesso</label>
                    <input type="text" class="form-control" name="nivelAcess" id="formGroupExampleInput2" placeholder="Senha do Usuário">
                </div>
  ...
  <div class="modal fade" id="ExcluirP" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    ...
    <script>
      var exampleModal = document.getElementById('AlterU')
      ...
      var senha = button.getAttribute('data-bs-whatever-senha')
      var nivelAcess = button.getAttribute('data-bs-whatever-nivelAcess')
      form.setAttribute('action', '../Controllers/AlterarUsuario.controller.php?id=' + id);
      ...
      modalBodyInput[1].value = senha
      modalBodyInput[2].value = nivelAcess
    })
    ...
    var excluirP = document.getElementById('ExcluirP')
      ...
      var id = button.getAttribute('data-bs-id')
      btnExcluir.setAttribute('href', '../Controllers/DeletarUsuario.controller.php?id=' + id);
      })
