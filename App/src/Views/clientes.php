    ...
    <section class="prod">
        <div class="table-responsive col-lg-12" >
          <table class="table table-hover table-bordeless" style="background-color: #f2f2f2;">
            <h1 class="produtos">Tabela de Clientes <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#CadastroC" style="background-color: #00ff7f;"><i class="bi-plus-lg" style="color: var(--terciary);"></i></button></td></h1>
            ...
            <tbody>
              <?php
              include "../Controllers/TabelaCliente.controller.php";
              listarClientes();
              ?>
            </tbody>
          </table>
...
<!-- Modal -->
<div class="modal fade" id="CadastroC" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="../Controllers/CriarCliente.controller.php" method="POST" class="fornecedor">
          <h1 class="cadP">Cadastro do Cliente</h1>
          <div class="mb-3 row g-3">
              <label for="formGroupExampleInput" class="form-label">Nome</label>
              <input type="text" class="form-control" name="nome" id="formGroupExampleInput" placeholder="Nome do Cliente">
          </div>
          <div class="mb-3 row g-3">
              <label for="formGroupExampleInput2" class="form-label">Telefone</label>
              <input type="text" class="form-control" name="numTel" id="formGroupExampleInput2" placeholder="Telefone do Cliente">
          </div>
          <div class="mb-3 row g-3">
              <label for="formGroupExampleInput2" class="form-label">CPF</label>
              <input type="text" class="form-control" name="cpf" id="formGroupExampleInput2" placeholder="CPF do Cliente">
          </div>
    ...
    <div class="modal fade" id="AlterC" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <!-- <h5 class="modal-title" id="staticBackdropLabel">Modal title</h5> -->
          ...
          <div class="modal-body">
            <form action="" method="POST" id="formAlterar" class="fornecedor">
              <h1 class="cadP">Alterar Cliente</h1>
              <div class="mb-3 row g-3">
                  <label for="formGroupExampleInput" class="form-label">Nome</label>
                  <input type="text" class="form-control" name="nome" id="formGroupExampleInput" placeholder="Nome do Cliente">
              </div>
    ...
    <script>
      var exampleModal = document.getElementById('AlterC')
      ...
      var cpf = button.getAttribute('data-bs-whatever-cpf')
      var telefone = button.getAttribute('data-bs-whatever-telefone')
      form.setAttribute('action', '../Controllers/AlterarCliente.controller.php?id=' + id);
      ...
      modalBodyInput[1].value = telefone
      modalBodyInput[2].value = cpf
    })
    ...
    var excluirP = document.getElementById('ExcluirP')
      ...
      var id = button.getAttribute('data-bs-id')
      btnExcluir.setAttribute('href', '../Controllers/DeletarCliente.controller.php?id=' + id);
      })
  </script>
