    ...
    <section class="prod">
        <div class="table-responsive col-lg-12" >
          <table class="table table-hover table-bordeless" style="background-color: #f2f2f2;">
            <h1 class="produtos">Tabela de Produtos <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#CadastroP" style="background-color: #00ff7f;"><i class="bi-plus-lg" style="color: var(--terciary);"></i></button></td></h1>
...
<div class="modal fade" id="CadastroP" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="../Controllers/CriarProduto.controller.php" method="post" class="fornecedor">
          <h1 class="cadP">Cadastro do Produto</h1>
          <div class="mb-3 row g-3">
              <label for="formGroupExampleInput" class="form-label">Nome</label>
              <input type="text" class="form-control" id="formGroupExampleInput" name="nome" placeholder="Nome do Produto">
          </div>
          <div class="mb-3 row g-3">
              <label for="formGroupExampleInput2" class="form-label">Fornecedor</label>
              <select class="form-select" name="idFor" aria-label="Default select example">
                <option selected>Selecione um Fornecedor</option>
                <?php
                  include_once "../Controllers/TabelaFornecedor.controller.php";
          ...
          <div class="mb-3 row g-3">
              ...
              <input type="text" class="form-control" id="formGroupExampleInput2" name="quant" placeholder="Quantidade de Produtos">
          </div>
          <div class="mb-3 row g-3">
              <label for="formGroupExampleInput2" class="form-label">Valor</label>
              <input type="text" class="form-control" id="formGroupExampleInput2" name="valor" placeholder="Valor do Produto">
          </div>
...
<div class="modal fade" id="AlterP" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form action="" id="formAlterar" method="POST" class="fornecedor">
              <h1 class="cadP">Alterar Produto</h1>
              <div class="mb-3 row g-3">
                  <label for="formGroupExampleInput" class="form-label">Nome</label>
                  <input type="text" class="form-control" name="nome" id="formGroupExampleInput" placeholder="Nome do Produto">
              </div>
              <div class="mb-3 row g-3">
                  <label for="formGroupExampleInput2" class="form-label">Fornecedor</label>
                  <input type="text" class="form-control" name="idFor" id="formGroupExampleInput2" placeholder="Nome do Fornecedor">
              </div>
              <div class="mb-3 row g-3">
                  <label for="formGroupExampleInput2" class="form-label">Quantidade</label>
                  <input type="text" class="form-control" name="quant" id="formGroupExampleInput2" placeholder="Quantidade de Produtos">
              </div>
              <div class="mb-3 row g-3">
                  <label for="formGroupExampleInput2" class="form-label">Valor</label>
                  <input type="text" class="form-control" name="valor" id="formGroupExampleInput2" placeholder="Valor do Produto">
              </div>
...
<div class="modal fade" id="ExcluirP" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    ...
    <script>
      ...
      var idFor = button.getAttribute('data-bs-idFor')
      var quant = button.getAttribute('data-bs-quant')
      var valor = button.getAttribute('data-bs-valor')
      form.setAttribute('action', '../Controllers/AlterarProduto.controller.php?id=' + id);
      ...
      modalBodyInput[1].value = idFor
      modalBodyInput[2].value = quant
      modalBodyInput[3].value = valor
      ...
      var id = button.getAttribute('data-bs-id')
      btnExcluir.setAttribute('href', '../Controllers/DeletarProduto.controller.php?id=' + id);
      })
    </script>
